        ...
        <div>
            ...
            <ul>
                <li> <span class="bold">BYU School of Accountancy Hub Technical Team, Web Developer, Feb 2019 – Present, Provo, UT</span>
                    <ul>
                        <li>Redesign and customize <Link target="_blank" to="https://internationalhub.org">InternationalHub.org</a> with Wordpress tools</li>
                        <li>Maintain Hub websites (<a target={_blank} href="https://ipohub.org">IPOhub.org</a>, <a target={_blank} href="https://revenuehub.org">RevenueHub.org</a>) updated with current content</li>
            ...
            <ul>
                ...
                <li><span class="bold">Achievements:</span> <a target={_blank} href="https://is415machinelearningnelson.azurewebsites.net/Default.aspx">Azure Machine Learning Example (Contact Me Through LinkedIn for Authentication Details)</a></li>
            </ul>
          </div>
        </div>
      </div>
